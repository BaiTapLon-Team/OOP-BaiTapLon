    ...
    <div class="main">
        ...
        <div class="content">
            <div class="action">
                ...
                <a href="<c:url value="/manage-teacher/add-teacher"/> " class="add-content">Thêm mới</a>
                <form action="<c:url value="/manage-teacher/search"/> " class="search-from" method="get">
            ...
            <table class="table">
                ...
                <c:forEach var="teacher" items="${ teachers }">
                    <tr>
                        ...
                        <td><a class="action-ob" href="<c:url value="/manage-teacher/edit?id=${teacher.id}"/> ">Sửa</a><a class="action-ob" href="<c:url value="/manage-teacher/edit-delete?id=${teacher.id}"/> ">Xóa</a></td>
                    </tr>
                </c:forEach>
            </table>
