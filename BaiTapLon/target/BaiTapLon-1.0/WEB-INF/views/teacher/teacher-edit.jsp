...
<div class="wrapper">
    ...
    <div class="main">
        ...
        <div class="content">
            <div class="view-info">
                <h1 id="titel-info">Chỉnh sửa thông tin giảng viên</h1>
                <c:url value="/manage-teacher/edit-db?id=${teacher.id}" var="url"/>
                <form:form action="${url}" id="box-info" modelAttribute="teacher" method="post">
                    ...
                    <div class="info">
                        ...
                        <form:input type="text" id="coefficientsSalary" path="coefficientsSalary"  value="${ teacher.coefficientsSalary }" />
                    </div>
                    <div class="save-info">
