...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/resources/css/thi-online.css"/> ">
        ...
        <div class="main">
            ...
            <form method="post" action="<c:url value="/sinhvien/ket-qua-thi"/>">
                <c:forEach var="index" begin="0" end="${questionList.size() - 1}">
                    <div class="question">
                        <input type="hidden" name="questionID${index}"
                               value="${questionList[index].questionID}">
                        ...
                        <h3><input type="radio" name="${index}" id="${index}"
                                   value="${questionList[index].anwserB}">
                                ${questionList[index].anwserB}.</h3>
                        <h3><input type="radio" name="${index}" id="${index}"
                                   value="${questionList[index].anwserC}">
                                ${questionList[index].anwserC}.</h3>
                        <h3><input type="radio" name="${index}" id="${index}"
                                   value="${questionList[index].anwserD}">
                                ${questionList[index].anwserD}.</h3>
                    </div>
                </c:forEach>
