            ...
            <div class="view-info">
                ...
                <form:form action="${url}" id="box-info" modelAttribute="teacher" method="post">
                    <div class="info">
                        ...
                        <form:input type="text" id="magv" value="${ teacher.id.trim() }"  path="id" disabled="true" name="magv"/>
                    </div>
                    <div class="info">
                        <label for="name">Họ và tên</label>
                        <form:input type="text" id="name" value="${ teacher.name.trim() }" path="name" name="name"/>
                    </div>
                    <div class="info">
                        <label for="username">Username</label>
                        <form:input type="text" id="username" value="${ teacher.username.trim() }" disabled="true" path="username" name="username"/>
                    </div>
                    <div class="info">
                        <label for="birthday">Ngày sinh</label>
                        <form:input type="text" id="birthday" value="${ teacher.birthday.trim() }" path="birthday" name="birthday"/>
                    </div>
                    <div class="info">
                        <label for="gender">Giới tính</label>
                        <form:input type="text" id="gender" value="${ teacher.gender.trim() }" path="gender" name="gender"/>
                    </div>
                    <div class="info">
                        <label for="address">Địa chỉ</label>
                        <form:input type="text" id="address" value=" ${ teacher.address.trim() }" path="address" name="address"/>
                    </div>
                    <div class="info">
                        <label for="phone">Số điện thoại</label>
                        <form:input type="text" id="phone" value="${ teacher.phone.trim() }" path="phone" name="phone"/>
                    </div>
                    <div class="info">
                        <label for="email">Email</label>
                        <form:input type="text" id="email" value="${ teacher.email.trim() }" path="email" name="email"/>
                    </div>
                    <div class="info">
